...
* Выявленные проблемы:
** Тратится много времени на ручное оценивание сотрудников: потребуются серьезные затраты времени на информирование участников, а после проведения оценки — на обработку данных и анализ результатов, нужно самому искать место для хранения результатов, сложность соблюдения конфиденциальности.
** Сотрудник не имеет доступа к информационным и организационным ресурсам компании (отделы, должности и требования к ним, команды).
** При проведении планирования карьеры с наставником должен заботиться о том, где и как хранить данные о сотрудниках.
* Цель: автоматизировать процессы развития персонала.
* Требования: конечная система должна быть проста в использовании, как для HR, так и для сотрудников.
* Ожидаемый результат: система с готовым функционалом для оценки сотрудников и планирования карьеры.
* Ресурсы, необходимые для достижения ожидаемого результата: HR-сотрудники должны будут наполнить систему данными, эксперты должны определиться с оценочными навыками и заполнить матрицу компетенций в системе.
* Процессы (запланированные действия):
** анализ современных методов оценки навыков.
** анализ реализаций мероприятий по планированию карьеры с наставником и самостоятельно сотрудником.
** разработка системы.
** апробация разработанной системы.
2. Этап Do (Выполнение): Команда разработчиков выполняют запланированные действия.
3. Этап Check (Проверка): После разработки системы производится оценка ее эффективности и удобства.
