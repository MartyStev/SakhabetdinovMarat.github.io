...
Таким образом на выгрузку данных всего объекта затрачивается меньше времени более чем в 17 раз, где экономия составит 32 мин в день.
...
- оценки наблюдаемой разницы в числах
