...
Расчет сложности разработки FPA IFPUG определил 2270 строк кода. Учитывая тот факт, что разработка велась в пределах одной платформы, сокращение затрат на разработку составило около 30%.
