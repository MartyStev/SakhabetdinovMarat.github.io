...
* Выявленные проблемы:
~ тратится много времени на обслуживание систем в течение дня
~ траты времени на постоянный мониторинг показателей (cбор информации)
~ долгий простой, до обнаружения ошибки

* Цель: оптимизировать временные затраты на обслуживание инженерных систем

* Требования: повысить эффективность необходимо без перегрузки работника

* Ожидаемый результат: повышение эффективности инженерных систем

* Ресурсы, необходимые для достижения ожидаемого результата: информационная система управления устройствами предприятия

* Процессы (запланированные действия):
~ анализ существующих инженерных систем
~ разработка системы
~ интеграция разработанной системы и инженерных систем

2. Этап Do(Выполнение):
Команда разработки и сотрудники предприятия выполняют поставленные задачи
